...
__DEFINE__(1661866494271, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1661866494272,"./event-store":1661866494273}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1661866494272, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1661866494273, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1661866494272,"./utils":1661866494274}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1661866494274, function(require, module, exports) {
...
return __REQUIRE__(1661866494271);
})()
